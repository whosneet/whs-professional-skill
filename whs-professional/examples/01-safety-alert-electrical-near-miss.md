...
- The work order said "general cleaning", with no isolation requirements
- The worker held a general electrical induction but no switchboard-specific
  competency

**Critical risk**: Electrical Safety
**Critical control absent**: Verified isolation before access to live components

*[Image: switchboard panel showing dust accumulation and bus bar exposed; arrow indicating point of contact. Caption: rear of MSB-3 prior to isolation — bus bar at top of frame is unisolated 415V three-phase.]*
...
| **Further information** | **Authorised by** | | **Useful resources** |
|---|---|---|---|
| A. Singh, Head of WHS, 02 9000 0000, asingh@example.com.au | S. Wong, Head of Property Services, 02 9000 0001, swong@example.com.au | | Incident Management Procedure; AS/NZS 4836 *Safe working on or near low-voltage and extra-low voltage electrical installations and equipment* |
