...
Acronyms, abbreviations, and frequently used terms across AU and NZ WHS practice.
Load this file when the user is new to WHS or asks what a term means.

---

## Acts, Regulations & Bodies

| Term | Meaning |
|---|---|
| **WHS Act** | Work Health and Safety Act — the principal AU statute. Most jurisdictions have their own version mirroring the model law (NSW, QLD, SA, TAS, ACT, NT, Cth, WA). |
| **OHS Act** | Occupational Health and Safety Act — Victoria's equivalent (2004). |
| **HSWA** | Health and Safety at Work Act 2015 (NZ). |
| **Model WHS Act / Regulations** | The template Act and Regulations developed by Safe Work Australia and adopted (with local variations) by harmonised jurisdictions. |
| **SWA** | Safe Work Australia — the national policy body that develops model WHS laws and codes. |
...
| Term | Meaning |
|---|---|
| **PCBU** | Person Conducting a Business or Undertaking — the primary duty holder under AU/NZ WHS law. |
| **Officer** | A person who makes or participates in decisions affecting the whole or a substantial part of a business (s 9 Corporations Act / s 4 WHS Act); carries a positive due diligence duty. |
...
| **AIIMS** | Australasian Inter-service Incident Management System — emergency response and coordination framework used by emergency services and industry. |
...
| Term | Meaning |
|---|---|
| **Safety I** | Safety as the absence of accidents; reactive control orientation (Hollnagel). |
| **Safety II** | Safety as the presence of successful outcomes; learning from what goes right (Hollnagel). |
| **HOP** | Human and Organisational Performance — operational philosophy emphasising that error is normal and blame fixes nothing (Conklin). |
| **Swiss Cheese Model** | Reason's model of accidents resulting from alignment of latent and active failures through defensive layers. |
| **WAD vs WAI** | Work-as-Done vs Work-as-Imagined — the gap between how work actually happens and how procedures describe it. |
| **ETTO** | Efficiency-Thoroughness Trade-Off — the unavoidable trade-off between doing things efficiently and thoroughly (Hollnagel). |
| **FRAM** | Functional Resonance Analysis Method — a tool for analysing complex socio-technical systems (Hollnagel). |
| **HRO** | High Reliability Organisation — organisations operating in high-risk environments with low failure rates (Weick & Sutcliffe). |
| **Psychological Safety** | The belief that one will not be punished or humiliated for speaking up (Edmondson). |
...
| Term | Meaning |
|---|---|
| **BU** | Business Unit — a divisional or contract-level unit within a larger organisation. |
...
| **ISO 45001** | International occupational health and safety management system standard (2018). |
| **ISO 31000** | International risk management standard. |

---

## Document Types (commonly seen in WHS document numbering)
