...
programmes, or through misapplication of frameworks designed for narrative purposes
...
Komaki and colleagues, who in the early 1980s ran the first published studies applying
...
- **Behavioural Science Technology (BST)**, founded by Krause, Hidley and Hodson —
  marketed a more behaviourally rigorous variant with peer-led observation teams,
...
The standard BBS programme follows a consistent pattern, regardless of brand:
...
- Quarterly review of trending at-risk behaviours; programme adjustment
...
**Hopkins** (*Failure to Learn*, 2008; *Disastrous Decisions*, 2012). BBS focuses
...
programme, that suffered a process safety catastrophe killing 15 workers because
...
Deepwater Horizon, and other major-accident reviews show the same pattern. Cross-reference
`frameworks.md` §12 for Hopkins citations.

**Provan** (*Safety Differently*, with Dekker, 2018; Griffith PhD on the safety
professional role). BBS positions the safety professional as observer-trainer,
...
invested in running a BBS programme — observer training, card data entry,
aggregate reporting, programme governance — is typically not justified by outcomes
data. The opportunity cost is the systems-level work the safety professional could
otherwise be doing: critical control verification, Learning Teams, capacity
assessment, advisor work with line management.

**Hollnagel** (*From Safety-I to Safety-II*, 2014). BBS counts deviations from
...
| Finding | Notes |
|---|---|
| Modest reductions in minor injuries during active deployment | Most studies show a 20–40% reduction in observable behavioural injuries during the programme period |
| Outcomes typically not sustained post-programme | When observation cadence drops or the programme ends, behavioural metrics regress |
...
Meta-analyses (e.g., Tuncel et al., 2006; LaMontagne et al.) suggest a small
...
- BBS programmes where observation count becomes the metric — gaming is then
  guaranteed
...
- Leadership uses BBS observation data in performance management or disciplinary
  ...
  them, they will avoid being observed at all — undermining the entire programme.
...
### If Your Organisation Has an Active BBS Programme

A pragmatic position. Most large organisations in heavy industry have inherited
BBS programmes that are politically and contractually difficult to dismantle.
...
> **Practical implications**: When asked to advise on a BBS programme — design,
> review, refresh, or wind-down — open with the position and the evidence base.
> Do not produce a BBS programme design as if the framework were uncontested.
...
Developed by Patrick Hudson (Leiden University; later visiting at the University
of Aberdeen), originally for Shell in the petroleum industry. Hudson's ladder
...
the pyramid appears in a board paper or programme design, flag it.
...
| Management lever | System change, leadership behaviour, hiring | Communication, programmes, leadership signals |
...
### Reason's Five Subcultures

Reason (*Managing the Risks of Organizational Accidents*, 1997) decomposes
"safety culture" into five interlocking subcultures. The model remains the most
...
| **Informed** | The organisation knows about its hazards, controls, and the state of both at any time | Critical control health is visible; HiPo intelligence is current; data is acted on |
...
the sharp end, and the other three cannot function. This is why disciplinary
...
|---|---|---|---|
| **NOSACQ-50** (Nordic Occupational Safety Climate Questionnaire) | Kines et al., 2011; National Research Centre for the Working Environment (Denmark) | 50 items, 7 dimensions | Validated across multiple languages and industries; free to use with registration; standard Nordic / European choice |
| **HSE UK Safety Climate Survey** | UK Health and Safety Executive | Multiple versions; 40–70 items | Free; UK regulator-aligned; widely used in UK process industries |
| **Loughborough Safety Climate Tool** | Loughborough University | Variable | Academic instrument; often used in research |
| **DNV ISRS** (International Safety Rating System) | DNV (commercial) | Variable | Commercial; broader management system assessment with climate components |
...
| Pulse (quarterly or monthly, 5–7 questions) | Specific question; rapid feedback on programme launch or change; not a substitute for the full survey |
...
| Low scores on critical control awareness | Programme has not landed at the front line | Review programme reach and facilitator quality (see `programs.md` §4) |
...
- [ ] **BBS programme position is informed by current evidence base, not legacy
      adoption**. If a BBS programme is proposed, designed, or being defended,
...
- [ ] **Named theorists are cited correctly where the framework or critique
      ...
      Provan, Hollnagel for the BBS critique; Hudson for the cultural ladder;
      DuPont for the Bradley Curve; Heinrich for the pyramid; Manuele and
      Hopkins for the pyramid critique; Reason for the five subcultures;
      Edmondson for psychological safety
...
and named programmes that may include BBS elements, load `references/company.md`.
